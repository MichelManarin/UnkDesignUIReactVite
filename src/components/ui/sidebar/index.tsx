      ...
      <div className="side-menu">
        ...
        <div className="itens-menu">
          ...
          <a className="sidebar-link" href="#">
            <svg strokeWidth={0.5} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
