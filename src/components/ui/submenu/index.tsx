...
const Submenu: React.FC = () => {
  return <div className="row mt-4 flex-row-container">
    <div className="col flex-item">
      <div className="fast-menu mt-2">
        <div className="row">
          <div className="col-lg-12">
            <span className="icon">
              <svg className="fast-icon size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="{1.5}" stroke="currentColor">
    ...
    <div className="col flex-item">
      <div className="fast-menu mt-2">
        <div className="row">
          <div className="col-lg-12">
            <span className="icon">
              <svg className="fast-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
